    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <p class="card-text"><?= $pesanan['tanggal_order'] ?></p>
                </div>
            </div>
            <div class="row">
                <p class="col-sm-2">Tanggal Sewa</p>
                <div class="col-sm-10">
                    <p class="card-text"><?= $pesanan['tanggal_sewa'] ?></p>
                </div>
            </div>
            <div class="row">
                <p class="col-sm-2">Tanggal Kembali</p>
                <div class="col-sm-10">
                    <p class="card-text"><?= $pesanan['tanggal_kembali'] ?></p>
                </div>
            </div>
            <div class="row">
                <p class="col-sm-2">Tanggal Bayar</p>
                <div class="col-sm-10">
                    <p class="card-text"><?= $pesanan['tanggal_bayar'] ?></p>
                </div>
            </div>
